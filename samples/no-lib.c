...
__attribute__((multiverse, section(".data"))) bool config_first = false; // NOLINT
__attribute__((multiverse, section(".data"))) bool config_second = true; // NOLINT
__attribute__((multiverse, section(".data"))) bool config_third = false; // NOLINT
